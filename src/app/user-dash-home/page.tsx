          ...
          <div className="max-w-screen-xl mx-auto p-4 mt-4 mb-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
              ...
              >
                ...
                <div>
                  <p className="px-6 py-2 font-normal text-base">
                    നിങ്ങൾ അപ്‌ലോഡ് ചെയ്തവ കാണാൻ
                  </p>
                </div>
              </Link>
              ...
              <Link
                className="flex flex-col justify-start items-start gap-3 text-xl border-2 border-dashed border-primary rounded-3xl py-6 md:py-10 bg-white hover:bg-primary/10 transition-all hover:scale-105"
                href={`user-dash-home/my-activities?id=${id}`}
              >
                <div className="flex flex-row items-center justify-between w-full px-6 py-2 bg-light-green">
                  <p className="font-semibold text-xl">My Activities</p>
                  <List size={48} color="#6c7260" strokeWidth={1.75} />
                </div>
                <div>
                  <p className="px-6 py-2 font-normal text-base">
                    Your activities
              ...
              >
                ...
                <div>
                  <p className="px-6 py-2 font-normal text-base">
                  All your details, Update your info.
                  </p>
                </div>
              </Link>
              ...
              <Link
                className="flex flex-col justify-start items-start gap-3 text-xl border-2 border-dashed border-primary rounded-3xl py-6 md:py-10 bg-white opacity-50"
                href={"#"}
              >
                <div className="flex flex-row items-center justify-between w-full px-6 py-2 bg-light-green">
